view: tree_census_2015_bigquery {
  ...
  filter: species_count_picker {
    ...
    type: string
    group_label: "Species Info"
    suggest_explore: tree_census_2015_bigquery
    suggest_dimension: tree_census_2015_bigquery.species_common
  }
  ...
  measure: species_count {
    ...
    sql:
    CASE
      WHEN {% condition species_count_picker %} ${tree_census_2015_bigquery.species_common} {% endcondition %}
      THEN 1
      ELSE 0
    END
  ;;
